...
export default function HomeBody() {
  return (
    ...
    <main className="font-body bg-neutral">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-8 pb-16 md:pt-16 md:pb-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 flex flex-col items-start">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-secondary-fixed/30 text-on-secondary-fixed-variant rounded-full font-label text-[10px] md:text-xs font-bold mb-4 md:mb-6 tracking-wide uppercase">
          ...
          <div className="lg:col-span-5 relative mt-10 lg:mt-0">
            <div className="relative z-10 rounded-4xl overflow-hidden shadow-xl rotate-1 transition-transform hover:rotate-0 duration-700">
              ...
              <div className="absolute bottom-4 left-4 right-4 p-3 md:p-4 bg-white/85 backdrop-blur-md rounded-2xl flex items-center gap-3 md:gap-4 border border-white/20 shadow-sm">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-secondary-fixed flex items-center justify-center text-primary">
      ...
      <section className="py-16 md:py-20 bg-surface-container-low mt-8 md:mt-12" id="features">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 auto-rows-[200px] md:auto-rows-[220px]">
            <div className="md:col-span-8 bg-white rounded-3xl md:rounded-4xl p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-center shadow-sm hover:shadow-md transition-all">
              <div className="flex-1">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-secondary-fixed/50 rounded-xl md:rounded-2xl flex items-center justify-center text-primary mb-4 md:mb-6">
              ...
              <div className="flex-1 w-full h-full min-h-40 md:min-h-45 rounded-xl md:rounded-2xl overflow-hidden">
            ...
            <div style={tealPulse} className="md:col-span-4 text-white rounded-3xl md:rounded-4xl p-6 md:p-8 flex flex-col justify-between shadow-xl">
              <div className="w-12 h-12 md:w-14 md:h-14 bg-white/20 rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6">
              ...
              <div>
                ...
                <span className="inline-flex items-center gap-1.5 md:gap-2 text-xs md:text-sm font-bold bg-white/10 px-3 py-1.5 md:px-4 md:py-2 rounded-full mt-2">
